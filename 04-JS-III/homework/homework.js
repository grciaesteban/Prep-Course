...
function todosIguales(arreglo) {
  ...
  //Escribe tu código aquí 
  //Se le agrega el menos 1 para que de esa forma el bucle termine en la anteúltima 
  //posición y a ese elemento lo compare con el último. Si yo no pongo el -1, 
  //me va a querer comparar el último elemento con el siguiente y me daría error.
...
function mayorACien(array) {
  ...
  var valoresMay100 = [];
  for ( var i = 0; i < array.length ; i++){
    if (100<array[i]) valoresMay100.push(array[i]);
  }
  return valoresMay100;
}
